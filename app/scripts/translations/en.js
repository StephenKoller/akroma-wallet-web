...
HELP_0_Desc_1                   :  'Akroma Web Wallet gives you the ability to generate new wallets so you can store your Ether yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_4CX_Title                  :  '4) How do I send Ether using Akroma Web Wallet CX?',
...
HELP_8_Desc_2                   :  'If wallet.akroma.io goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your Ether out of Akroma Web Wallet because it\'s not in Akroma Web Wallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Desc_2                 :  'That said, it is **very important** that you back up all your information for any new wallets generated with Akroma Web Wallet CX. That way if anything happens to Akroma Web Wallet CX or your computer, you still have all the information necessary to access your Ether. See the #2a for how to back up your wallets.',
...
HELP_Remind_Desc_2              :  'wallet.akroma.io & Akroma Web Wallet CX are not "web wallets". You do not create an account or give us your Ether to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
